// ============================================
// XPLITLEAKS API - CLOUDFLARE WORKER v3.1
// Complete Backend with D1 + R2 + Creator System
// Merged: New features + Old auth/report/CORS enhancements
// ============================================
...
export default {
    async fetch(request, env, ctx) {
        ...
        // ============================================
        // AUTH HELPERS - Flexible header support
        // ============================================
        ...
        try {
            ...
            if (path === "/api/videos/related" && method === "GET") {
                ...
                // Get the video's category for better recommendations
            ...
            if (path === "/api/shorts/recommend" && method === "GET") {
                ...
                return jsonResponse(diversified.map(normalizeVideo));
            }
            ...
            // ============================================
            // REPORT ENDPOINT - PUBLIC (BEFORE ADMIN AUTH)
            // Enhanced with email/name/phone from old worker
            // ============================================
            ...
            // Upload Video - FIXED with fake views and views = fakeViews
            ...
            // Upload Short - FIXED with fake views and views = fakeViews
            ...
            // R2 File Upload - FIXED with robust https:// handling
            if (path === "/api/upload/file" && method === "POST") {
                ...
                try {
                    ...
                    r2Host = r2Host.replace(/^https?:\/\//, "");   // strip accidental protocol
                    r2Host = r2Host.replace(/\/+$/, "");            // strip trailing slashes

                    if (!r2Host) {
                        return errorResponse("R2_PUBLIC_URL not configured in worker environment", 500);
                    }
            ...
            // Get Admin Stats - FIXED with real views and daily short stats
            if (path === "/api/admin/stats" && method === "GET") {
                ...
                // Get total REAL views (for admin dashboard)
                ...
                // Get daily stats with REAL views
            ...
            // Update Report Status (Admin) - FIXED
